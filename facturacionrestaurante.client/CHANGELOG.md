...
- Cree un proyecto de React con create-vite: `npm init --yes vite@latest facturacionrestaurante.client -- --template=react-ts  --no-rolldown --no-immediate`.
...
- Crear archivo de proyecto (`facturacionrestaurante.client.esproj`).
